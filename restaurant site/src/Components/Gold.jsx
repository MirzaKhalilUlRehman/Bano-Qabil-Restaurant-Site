...
const Gold = () => {
  return (
    <section className="bg-black relative py-[15rem] mt-[20rem] text-white flex items-center justify-center flex-col ">
      <img src={GOLD_IMG_URL} alt="" className="w-[306px] h-[134px]" />
      ...
      <img src={GOLD_STAR_IMG_URL} alt="" className="w-[20rem] absolute top-0 right-0 rotate-150" />
      <img src={GOLD_STAR_IMG_URL} alt="" className="w-[15rem] absolute top-10 left-5 " />
      <img src={GOLD_STAR_IMG_URL} alt="" className="w-[6rem] absolute bottom-0 right-30 rotate-95" />
    </section>
  );
};
